...
class TopBar
{
    ...
    public function add_top_bar_link($wp_admin_bar)
    {
        ...
        $style = '<style>#wp-admin-bar-winden_editor a{background-color:#32393d!important;padding:0 10px!important}#wp-admin-bar-winden_editor .winden-topbar{display:flex!important;align-items:center!important;gap:10px!important}#wp-admin-bar-winden_editor a svg{width:1rem!important;height:1rem!important}</style>';
