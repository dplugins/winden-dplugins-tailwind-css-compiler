...
class FSEData
{
    ...
    public function add_wizzard_color_palette()
    {
        ...
        if ($includeUtilityColors) {
            $white_name = __('White', 'winden-tailwind-css-compiler');
            $black_name = __('Black', 'winden-tailwind-css-compiler');
            $transparent_name = __('Transparent', 'winden-tailwind-css-compiler');
            $inherit_name = __('Inherit', 'winden-tailwind-css-compiler');
            $current_name = __('Current', 'winden-tailwind-css-compiler');
