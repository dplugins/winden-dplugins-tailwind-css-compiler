 ...
 *
 * Extracted from node_modules/tailwindcss/theme.css
 * Colors are in OKLCH color space
 *
 * Use these for selective inclusion when extendColors is disabled
 */

export const tailwindDefaultColors: Record<string, Record<string, string>> = {
  amber: {
